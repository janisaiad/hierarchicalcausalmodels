...
def idfixall(G, X = {}, Y ={}, mode = "shortest", greedy = True):
    ...
    - 'shortest': a Latex string of identified equation with the least number of distributions.py, its corresponding Eqn object and a boolean indicating if the causal effect is identifiable.
