...
|---|---|---:|---:|---:|---:|
| `PC` | `ok` | yes | 0.0000 | 0.5468 | 0.5468 |
| `FCI` | `ok` | yes | 0.0000 | 0.5468 | 0.5468 |
| `DirectLiNGAM` | `ok` | yes | -15.0253 | 615.9056 | 630.9309 |
| `ExactBIC` | `ok` | yes | 2342.7951 | 490266.3795 | 487923.5844 |
| `ConsensusMean` | `ok` | yes | 0.0000 | 0.5468 | 0.5468 |
